...
function HomePage({ setTab }: { setTab: (tab: Tab) => void }) {
  const actions: {
    icon: string;
    title: string;
    sub: string;
...
function WeatherPage({
  ...
  const loadWeather = () => {
    ...
    if (!navigator.geolocation) {
      setError(
        "आपके फोन में Location उपलब्ध नहीं है।"
      );
      setLoading(false);
      return;
    }
  ...
  return (
    ...
    >
      ...
      <div className="card">
        ...
        <p>
          आपके live location से मौसम
          की जानकारी देखी जा सकती है।
        </p>
